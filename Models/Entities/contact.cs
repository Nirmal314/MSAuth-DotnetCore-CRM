...
namespace MSAuth.Models
{
	...
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum hiring_contact_hiring_department
	{
	...
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum hiring_contact_hiring_employmentstatus
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		ExEmployee = 414090002,
	}
	
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum hiring_contact_hiring_position
	{
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		JrDeveloper = 414090000,
		
		[System.Runtime.Serialization.EnumMemberAttribute()]
		SrDeveloper = 414090001,
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity
	{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("hiring_averagerating")]
		public System.Nullable<decimal> hiring_Averagerating
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<decimal>>("hiring_averagerating");
			}
			set
			{
				this.SetAttributeValue("hiring_averagerating", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("hiring_department")]
		public virtual hiring_contact_hiring_department? hiring_Department
		{
			get
			{
				return ((hiring_contact_hiring_department?)(EntityOptionSetEnum.GetEnum(this, "hiring_department")));
			}
			set
			{
				this.SetAttributeValue("hiring_department", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("hiring_employeeid")]
		public string hiring_EmployeeID
		{
			get
			{
				return this.GetAttributeValue<string>("hiring_employeeid");
			}
			set
			{
				this.SetAttributeValue("hiring_employeeid", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("hiring_employmentstatus")]
		public virtual hiring_contact_hiring_employmentstatus? hiring_EmploymentStatus
		{
			get
			{
				return ((hiring_contact_hiring_employmentstatus?)(EntityOptionSetEnum.GetEnum(this, "hiring_employmentstatus")));
			}
			set
			{
				this.SetAttributeValue("hiring_employmentstatus", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("hiring_hiredate")]
		public System.Nullable<System.DateTime> hiring_HireDate
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("hiring_hiredate");
			}
			set
			{
				this.SetAttributeValue("hiring_hiredate", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("hiring_manager")]
		public Microsoft.Xrm.Sdk.EntityReference hiring_Manager
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("hiring_manager");
			}
			set
			{
				this.SetAttributeValue("hiring_manager", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("hiring_position")]
		public virtual hiring_contact_hiring_position? hiring_Position
		{
			get
			{
				return ((hiring_contact_hiring_position?)(EntityOptionSetEnum.GetEnum(this, "hiring_position")));
			}
			set
			{
				this.SetAttributeValue("hiring_position", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<MSAuth.Models.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<MSAuth.Models.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<MSAuth.Models.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<MSAuth.Models.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<MSAuth.Models.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<MSAuth.Models.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public MSAuth.Models.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<MSAuth.Models.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<MSAuth.Models.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		...
		public MSAuth.Models.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<MSAuth.Models.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
}
